...
Pod::Spec.new do |s|
  s.name             = 'HZFrameWork'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HZFrameWork.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Runyalsj/HZFrameWork'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Runyalsj' => 'Runya_lsj@163.com' }
  s.source           = { :git => 'https://github.com/Runyalsj/HZFrameWork.git', :tag => s.version.to_s }
