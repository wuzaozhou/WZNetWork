...
@interface HZURLRequest : NSObject
/**
 *  用于标识不同类型的request状态
 */
 ...
 *  为上传请求提供数据
 */
@property (nonatomic, strong, nullable) NSMutableArray<HZUploadData *> *uploadDatas;
...
@interface HZBatchRequest : NSObject
...
/**
 上传文件数据的类
 */
@interface HZUploadData : NSObject
