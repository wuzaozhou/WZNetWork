...
@implementation UIImage (HZ_Add)

+ (UIImage *)hz_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale {
...
+ (BOOL)hz_isAnimatedGIFData:(NSData *)data {
...
+ (BOOL)hz_isAnimatedGIFFile:(NSString *)path {
...
+ (UIImage *)hz_imageWithPDF:(id)dataOrPath {
    return [self _yy_imageWithPDF:dataOrPath resize:NO size:CGSizeZero];
}

+ (UIImage *)hz_imageWithPDF:(id)dataOrPath size:(CGSize)size {
    return [self _yy_imageWithPDF:dataOrPath resize:YES size:size];
}

+ (UIImage *)hz_imageWithEmoji:(NSString *)emoji size:(CGFloat)size {
...
+ (UIImage *)hz_imageWithColor:(UIColor *)color {
    return [self hz_imageWithColor:color size:CGSizeMake(1, 1)];
}
...
+ (UIImage *)hz_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock {
...
- (void)hz_drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips{
...
- (UIImage *)hz_imageByResizeToSize:(CGSize)size {
...
- (UIImage *)hz_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode {
    if (size.width <= 0 || size.height <= 0) return nil;
    UIGraphicsBeginImageContextWithOptions(size, NO, [UIScreen mainScreen].scale);
    [self hz_drawInRect:CGRectMake(0, 0, size.width, size.height) withContentMode:contentMode clipsToBounds:NO];
    UIImage *image = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    return image;
}

- (UIImage *)hz_imageByCropToRect:(CGRect)rect {
...
- (UIImage *)hz_imageByInsetEdge:(UIEdgeInsets)insets withColor:(UIColor *)color {
...
- (UIImage *)hz_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize {
...
- (UIImage *)hz_imageByRotateLeft90 {
    return [self hz_imageByRotate:DegreesToRadians(90) fitSize:YES];
}

- (UIImage *)hz_imageByRotateRight90 {
    return [self hz_imageByRotate:DegreesToRadians(-90) fitSize:YES];
}

- (UIImage *)hz_imageByRotate180 {
    return [self _yy_flipHorizontal:YES vertical:YES];
}

- (UIImage *)hz_imageByFlipVertical {
    return [self _yy_flipHorizontal:NO vertical:YES];
}

- (UIImage *)hz_imageByFlipHorizontal {
    return [self _yy_flipHorizontal:YES vertical:NO];
}

- (UIImage *)hz_imageByTintColor:(UIColor *)color {
    UIGraphicsBeginImageContextWithOptions(self.size, NO, [UIScreen mainScreen].scale);
    CGRect rect = CGRectMake(0, 0, self.size.width, self.size.height);
    [color set];
    UIRectFill(rect);
...
- (UIImage *)hz_imageByGrayscale {
    return [self hz_imageByBlurRadius:0 tintColor:nil tintMode:0 saturation:0 maskImage:nil];
}

- (UIImage *)hz_imageByBlurSoft {
    return [self hz_imageByBlurRadius:60 tintColor:[UIColor colorWithWhite:0.84 alpha:0.36] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}

- (UIImage *)hz_imageByBlurLight {
...
- (UIImage *)hz_imageByBlurWithTint:(UIColor *)tintColor {
    ...
    return [self hz_imageByBlurRadius:20 tintColor:effectColor tintMode:kCGBlendModeNormal saturation:-1.0 maskImage:nil];
}
