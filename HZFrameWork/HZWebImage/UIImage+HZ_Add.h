 ...
 */
+ (nullable UIImage *)hz_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)hz_imageWithPDF:(id)dataOrPath;
...
/**
 ...
 @return A new image create from PDF, or nil when an error occurs.
 */
+ (nullable UIImage *)hz_imageWithPDF:(id)dataOrPath size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)hz_imageWithEmoji:(NSString *)emoji size:(CGFloat)size;
 ...
 */
+ (nullable UIImage *)hz_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)hz_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)hz_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock;
 ...
 */
- (nullable UIImage *)hz_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)hz_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)hz_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)hz_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 the width or height.
 */
- (nullable UIImage *)hz_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)hz_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)hz_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)hz_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)hz_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)hz_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)hz_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)hz_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 enough memory).
 */
- (nullable UIImage *)hz_imageByBlurRadius:(CGFloat)blurRadius
