...
- (void)hideAnimation {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(hiddenPhotoBrowser:)]) {
        [_delegate hiddenPhotoBrowser:self];
    }
}
...
//        self.frame = CGRectMake(0, 24, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 24);
//    } else {
//    }
...
- (void)setupToolbars {
    ...
    saveButton.layer.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.3].CGColor;
    ...
    if (self.imageCount > 9) {
        ...
        indexLabel.layer.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.3].CGColor;
        ...
        if (self.imageCount > 1) {
            ...
            CGSize size = [indexLabel.text boundingRectWithSize:CGSizeMake(kScreenWidth, 100) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:nil context:nil].size;
...
- (void)setupScrollView {
    ...
    if (self.imageCount <= 9 && self.imageCount > 1) {
...
-(void)longPressToDo:(UILongPressGestureRecognizer *)longRecognizer{
...
- (void)hintPhotoAuthority {
    ...
    [messageAtt addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithHexString:@"#333333"] range:NSMakeRange(0, message.length)];
    ...
    [cancelAction setValue:[UIColor colorWithHexString:@"#999999"] forKey:@"_titleTextColor"];
    [sureAction setValue:[UIColor colorWithHexString:@"#F8485E"] forKey:@"_titleTextColor"];
    [alertController addAction:sureAction];
    
    [_contentView presentViewController:alertController animated:YES completion:nil];
}
@end
