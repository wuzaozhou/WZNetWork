...
/** 缓存是否存储成功的Block */
typedef void(^HZCacheIsSuccessBlock)(BOOL isSuccess);
/** 得到缓存的Block */
typedef void(^HZCacheValueBlock)(NSData *data,NSString *filePath);
/** 缓存完成的后续操作Block */
typedef void(^HZCacheCompletedBlock)(void);

/**
 *  文件管理类:管理文件的路径,创建,存储,编码,显示,删除等功能.
 */
@interface HZCacheManager : NSObject
...
/**
 ...
 @return Library/Caches/HZKit/AppCache路径
 */
...
/**
 * 显示data文件缓存大小 默认缓存路径/Library/Caches/HZKit/AppCache
 * Get the size used by the disk cache
 */
- (NSUInteger)getCacheSize;

/**
 * 显示data文件缓存个数 默认缓存路径/Library/Caches/HZKit/AppCache
...
/**
 *  设置过期时间 清除路径下的全部过期缓存文件 默认路径/Library/Caches/HZKit/AppCache
...
/**
 *  清除某一个缓存文件      默认路径/Library/Caches/HZKit/AppCache
 *  @param key          请求的协议地址
 */
...
/**
 *  设置过期时间 清除某一个缓存文件  默认路径/Library/Caches/HZKit/AppCache
 *  @param key          请求的协议地址
...
/**
 *  清除磁盘缓存 /Library/Caches/HZKit/AppCache
