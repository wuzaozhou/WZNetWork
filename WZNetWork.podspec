...
Pod::Spec.new do |s|
  s.name             = 'WZNetWork'
  s.version          = '1.0.1'
  s.summary          = 'A short description of WZNetWork.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.author           = { 'wuzaozhou' => 'wuzaozhou@aliyun.com' }
  s.source           = { :git => 'https://github.com/wuzaozhou/WZNetWork.git', :tag => s.version.to_s }
